        ...
        <div className="px-6">
            ...
            <div className="w-full px-4 flex justify-center">
              <div className="relative">
                <img
                  ...
                  className="shadow-xl  h-auto align-middle border-100 absolute -m-16 -ml-20 lg:-ml-16 max-w-150-px"
                />
              </div>
            </div>
            <br></br><br></br>
          ...
          <div className="text-center mt-12">
            ...
            <div className="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold uppercase">
              ...
              User's Company Location(Los Angeles, California)
            </div>
            <div className="mb-2 text-blueGray-600 mt-10">
              <i className="fas fa-briefcase mr-2 text-lg text-blueGray-400"></i>
              User's Role (Solution Manager) 
            </div>
            <div className="mb-2 text-blueGray-600">
              <i className="fas fa-university mr-2 text-lg text-blueGray-400"></i>
              User's Education (University of Computer Science)
            </div>
          </div>
